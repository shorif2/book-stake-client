...
const featuredAuthors = [
  {
    ...
    rating: 4.8,
    followers: 2500,
    image: 'https://images.unsplash.com/photo-1494790108755-2616c79e1c0e?w=300&h=300&fit=crop&crop=face'
  },
  {
    id: 2,
    name: 'Neil Gaiman',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover works from our most celebrated authors and explore their literary contributions
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredAuthors.map((author) => (
            <Card key={author.id} className="card-modern group hover:shadow-elegant transition-smooth">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-muted-foreground">{author.booksCount} Books</span>
                    </div>
                    <div className="flex items-center space-x-1">
                      <Users className="h-4 w-4 text-accent" />
                      <span className="text-muted-foreground">{author.followers} Followers</span>
                    </div>
                  </div>
